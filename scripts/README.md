...
Scripts for recording a ~60-second, 1920x1080 gameplay video of SheManager touring all key screens of a La Liga career mode game. The recording is fully scripted via Playwright for repeatable, pixel-perfect takes.
...
| `BASE_URL` | No | `http://shemanager.test` | Base URL of your local SheManager instance |
...
- The app is running at the `BASE_URL` (default: `http://shemanager.test`)

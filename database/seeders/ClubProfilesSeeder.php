...
class ClubProfilesSeeder extends Seeder
{
    ...
    private const CLUB_DATA = [
        ...
        // =============================================
        // España Femenino — Liga F (ESF)
        // =============================================

        // Elite — FC Barcelona y Real Madrid dominan
        'FC Barcelona Femení'       => ClubProfile::REPUTATION_ELITE,
        'Atlético de Madrid Femenino' => ClubProfile::REPUTATION_ELITE,
        'Real Madrid CF Femenino'   => ClubProfile::REPUTATION_ELITE,

        // Continental — Top 4-6, aspiran a UWCL
        'Athletic Club Femenino'    => ClubProfile::REPUTATION_CONTINENTAL,
        'Real Sociedad Femenino'    => ClubProfile::REPUTATION_CONTINENTAL,
        'Levante UD Femenino'       => ClubProfile::REPUTATION_CONTINENTAL,

        // Established — Mid-table Liga F
        'Sevilla FC Femenino'       => ClubProfile::REPUTATION_ESTABLISHED,
        'Deportivo Abanca'          => ClubProfile::REPUTATION_ESTABLISHED,
        'RCD Espanyol Femenino'     => ClubProfile::REPUTATION_ESTABLISHED,
        'Madrid CFF'                => ClubProfile::REPUTATION_ESTABLISHED,
        'Granada CF Femenino'       => ClubProfile::REPUTATION_ESTABLISHED,
        'SD Eibar Femenino'         => ClubProfile::REPUTATION_ESTABLISHED,

        // Modest — Newly promoted / survival fight
        'DUX Logroño'               => ClubProfile::REPUTATION_MODEST,
        'Alhama CF ElPozo'          => ClubProfile::REPUTATION_MODEST,
        'FC Badalona Women'         => ClubProfile::REPUTATION_MODEST,

        // =============================================
        // España Femenino — Primera Federación Iberdrola
        // =============================================
        'FC Barcelona Femení B'              => ClubProfile::REPUTATION_CONTINENTAL,
        'Club Atlético de Madrid B'          => ClubProfile::REPUTATION_CONTINENTAL,
        'Real Madrid CF Femenino B'          => ClubProfile::REPUTATION_CONTINENTAL,
        'Villarreal CF Femenino'             => ClubProfile::REPUTATION_ESTABLISHED,
        'Deportivo Alavés Femenino'          => ClubProfile::REPUTATION_ESTABLISHED,
        'Real Oviedo Femenino'               => ClubProfile::REPUTATION_ESTABLISHED,
        'Fundación Real Betis Féminas'       => ClubProfile::REPUTATION_ESTABLISHED,
        'Valencia Féminas CF'                => ClubProfile::REPUTATION_ESTABLISHED,
        'CD Filial Fundación Club Atlético Osasuna' => ClubProfile::REPUTATION_MODEST,
        'CD Alba Fundación Femenino'         => ClubProfile::REPUTATION_MODEST,
        'Cacereño Femenino'                  => ClubProfile::REPUTATION_LOCAL,
        'SE AEM'                             => ClubProfile::REPUTATION_LOCAL,
        'CE Europa'                          => ClubProfile::REPUTATION_LOCAL,
        'CD Tenerife Femenino B'             => ClubProfile::REPUTATION_LOCAL,

        // =============================================
        // Google Pixel Frauen-Bundesliga (DEF)
        // =============================================
        'FC Bayern München'         => ClubProfile::REPUTATION_ELITE,
        'VfL Wolfsburg'             => ClubProfile::REPUTATION_ELITE,
        'Eintracht Frankfurt'       => ClubProfile::REPUTATION_CONTINENTAL,
        'Bayer 04 Leverkusen'       => ClubProfile::REPUTATION_CONTINENTAL,
        'SGS Essen'                 => ClubProfile::REPUTATION_ESTABLISHED,
        'SC Freiburg'               => ClubProfile::REPUTATION_ESTABLISHED,
        'TSG 1899 Hoffenheim'       => ClubProfile::REPUTATION_ESTABLISHED,
        'RB Leipzig'                => ClubProfile::REPUTATION_ESTABLISHED,
        'Hamburger SV'              => ClubProfile::REPUTATION_MODEST,
        '1. FC Köln'                => ClubProfile::REPUTATION_MODEST,
        'Werder Bremen'             => ClubProfile::REPUTATION_MODEST,
        '1. FC Union Berlin'        => ClubProfile::REPUTATION_MODEST,
        '1. FC Nürnberg'            => ClubProfile::REPUTATION_LOCAL,
        'Carl Zeiss Jena'           => ClubProfile::REPUTATION_LOCAL,

        // =============================================
        // Barclays Women's Super League (ENF)
        // =============================================
        'Chelsea FC Women'          => ClubProfile::REPUTATION_ELITE,
        ...
        'Liverpool FC Women'        => ClubProfile::REPUTATION_CONTINENTAL,
        'Aston Villa Women'         => ClubProfile::REPUTATION_ESTABLISHED,
        'Brighton & Hove Albion Women' => ClubProfile::REPUTATION_ESTABLISHED,
        'Tottenham Hotspur Women'   => ClubProfile::REPUTATION_ESTABLISHED,
        'West Ham United Women'     => ClubProfile::REPUTATION_MODEST,
        'Everton Women'             => ClubProfile::REPUTATION_MODEST,
        'Leicester City Women'      => ClubProfile::REPUTATION_MODEST,
        'London City Lionesses'     => ClubProfile::REPUTATION_LOCAL,

        // =============================================
        // Arkema Première Ligue (FRF)
        // =============================================
        'Olympique Lyonnais Féminin' => ClubProfile::REPUTATION_ELITE,
        'Paris Saint-Germain'        => ClubProfile::REPUTATION_ELITE,
        'Paris FC'                   => ClubProfile::REPUTATION_CONTINENTAL,
        'Dijon FCO'                  => ClubProfile::REPUTATION_ESTABLISHED,
        'FC Fleury 91'               => ClubProfile::REPUTATION_ESTABLISHED,
        'Montpellier HSC'            => ClubProfile::REPUTATION_ESTABLISHED,
        'FC Nantes'                  => ClubProfile::REPUTATION_ESTABLISHED,
        'Le Havre AC'                => ClubProfile::REPUTATION_MODEST,
        'RC Lens'                    => ClubProfile::REPUTATION_MODEST,
        'Racing Club de Strasbourg'  => ClubProfile::REPUTATION_MODEST,
        'Olympique de Marseille'     => ClubProfile::REPUTATION_MODEST,
        'AS Saint-Étienne'           => ClubProfile::REPUTATION_LOCAL,

        // =============================================
        // Serie A Women Athora (ITF)
        // =============================================
        'Juventus FC Women'          => ClubProfile::REPUTATION_ELITE,
        'AS Roma Femminile'          => ClubProfile::REPUTATION_ELITE,
        'FC Internazionale Women'    => ClubProfile::REPUTATION_CONTINENTAL,
        'AC Milan Women'             => ClubProfile::REPUTATION_CONTINENTAL,
        'ACF Fiorentina Women'       => ClubProfile::REPUTATION_ESTABLISHED,
        'US Sassuolo Women'          => ClubProfile::REPUTATION_ESTABLISHED,
        'FC Como Women'              => ClubProfile::REPUTATION_ESTABLISHED,
        'Genoa CFC Women'            => ClubProfile::REPUTATION_MODEST,
        'SS Lazio Women'             => ClubProfile::REPUTATION_MODEST,
        'Napoli Femminile'           => ClubProfile::REPUTATION_MODEST,
        'Parma Calcio Women'         => ClubProfile::REPUTATION_LOCAL,
        'Ternana Calcio Women'       => ClubProfile::REPUTATION_LOCAL,

        // =============================================
        // European transfer pool (EUR) — existing
        // =============================================

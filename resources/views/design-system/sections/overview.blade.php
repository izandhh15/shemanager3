<section id="overview" class="mb-20">
    <div class="mb-10">
        <h1 class="font-heading text-3xl lg:text-4xl font-bold uppercase tracking-wide text-text-primary mb-3">SheManager Design System</h1>
        <p class="text-sm text-text-secondary max-w-2xl leading-relaxed">A living reference of the UI patterns, components, and design tokens used across SheManager. Built on a dark-first aesthetic with dual typography, opacity-layered surfaces, and high information density for football management.</p>
    </div>

<section id="logo-brand" class="mb-20">
    ...
    <p class="text-sm text-text-secondary mb-8">The SheManager brand identity is built around a bold skewed red parallelogram with white text. The skew angle (-12deg) is the defining visual motif carried across logo, favicon, and UI accents.</p>
...
&lt;/svg&gt;</code></pre>
    ...
    <p class="text-sm text-text-secondary mb-4">The core elements that make up the SheManager visual identity.</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div class="border border-border-default rounded-xl overflow-hidden">
            <div class="p-6 flex items-center justify-center bg-surface-900 min-h-[120px]">
                <img src="/img/brand/logo-dark.png" alt="SheManager logo on dark background" class="h-12">
            </div>
        ...
        <div class="border border-border-default rounded-xl overflow-hidden">
            <div class="p-6 flex items-center justify-center bg-white min-h-[120px]">
                <img src="/img/brand/logo.png" alt="SheManager logo" class="h-12">
            </div>
            <div class="border-t border-border-default px-4 py-3 bg-surface-800 flex items-center justify-between">
                <div>
            ...
            <div class="flex flex-wrap items-end gap-6">
                ...
                <div class="text-center">
                    <div class="mb-1.5 inline-flex items-center justify-center">
                        <img src="/img/brand/{{ $icon['file'] }}" alt="SheManager icon {{ $icon['label'] }}" style="width: {{ $icon['display'] }}px; height: {{ $icon['display'] }}px;" class="rounded-sm">
                    </div>
                    <div class="text-[10px] text-text-muted">{{ $icon['label'] }}</div>
                </div>
                @endforeach

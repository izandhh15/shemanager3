                        ...
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                            ...
                            <div class="flex flex-col items-center md:items-start gap-3">
                                ...
                                <p class="text-xs text-text-faint">
                                    &copy; {{ date('Y') }} Izan Delgado &middot; <a href="https://github.com/izandhh/shemanager" target="_blank" class="hover:text-text-muted transition-colors">Proyecto Open Source</a> &middot; <a href="{{ route('legal') }}" class="hover:text-text-muted transition-colors">Aviso Legal</a>
                                </p>
                            </div>
